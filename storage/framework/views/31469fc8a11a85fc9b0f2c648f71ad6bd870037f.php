<div>
    ...
    <div class="row d-flex flex-row align-items-center p-2 m-0 w-100" id="navbar">
        ...
        <div class="d-flex flex-column">
            <div class="text-black font-weight-bold userName" id="name">
                <?php if(isset($userTicket->ticketUser->username)): ?>
                <?php echo e(ucfirst($userTicket->ticketUser->username)); ?>
        ...
        <div class="d-flex flex-row align-items-center ml-auto">
            ...
            <?php if($userTicket->status == 'open'): ?>
            <a title="Closed Ticket" href="javascript:;"
                wire:click="statusTicketConfirm('Closed',<?php echo e($userTicket->id); ?>)" class="btn btn-sm-my btn-danger">
                <i class="fa fa-toggle-off" aria-hidden="true"></i>
            </a>
            <?php else: ?>
            <a title="Open Ticket" href="javascript:;" wire:click="statusTicketConfirm('Open',<?php echo e($userTicket->id); ?>)"
    ...
    <!-- Input -->
    <?php if(isset($userTicket->id) && $userTicket->status == 'open'): ?>
    <form method="post">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__env->stopPush(); ?>
</div><?php /**PATH E:\workspace\web\clear-shop\resources\views/livewire/back-end/chat/chat-body.blade.php ENDPATH**/ ?>