									...
									<div class="row">
										...
										<div class="col-lg-12 col-xl-2 order-lg-1 order-xl-1">
											...
											<div class="k-portlet k-portlet--height-fluid">
												<div class="k-portlet__head  k-portlet__head--noborder">
													<div class="k-portlet__head-label">
														<h3 class="k-portlet__head-title"><?php echo e(__('backend/dashboard.articles_total.widget_title')); ?></h3>
													</div>
												</div>
												<div class="k-portlet__body k-portlet__body--fluid">
													<div class="k-widget-20">
														<div class="k-widget-20__title">
															<div class="k-widget-20__label"><?php echo e(App\Models\Article::count()); ?></div>
															<img class="k-widget-20__bg" src="<?php echo e(asset_dir('admin/assets/media/misc/iconbox_bg.png')); ?>" alt="bg" />
														</div>
													</div>
												</div>
										...
										<div class="col-lg-12 col-xl-2 order-lg-1 order-xl-1">
											...
											<div class="k-portlet k-portlet--height-fluid">
												<div class="k-portlet__head  k-portlet__head--noborder">
													<div class="k-portlet__head-label">
														<h3 class="k-portlet__head-title"><?php echo e(__('backend/dashboard.newsletter_total.widget_title')); ?></h3>
													</div>
												</div>
												<div class="k-portlet__body k-portlet__body--fluid">
													<div class="k-widget-20">
														<div class="k-widget-20__title">
															<div class="k-widget-20__label"><?php echo e(App\Models\User::where('newsletter_enabled', 1)->count()); ?></div>
															<img class="k-widget-20__bg" src="<?php echo e(asset_dir('admin/assets/media/misc/iconbox_bg.png')); ?>" alt="bg" />
														</div>
													</div>
												</div>
			...
			var recentOrdersInit = function() {
				...
				var datatable = $('#k_recent_orders').KDatatable({
					...
					columns: [{
						...
						field: 'customer_name',
						title: '<?php echo e(__('backend/dashboard.recent_orders.customer')); ?>'
					}, {
						field: 'product',
						title: '<?php echo e(__('backend/dashboard.recent_orders.product')); ?>'
					}, {
						field: 'price',
						title: '<?php echo e(__('backend/dashboard.recent_orders.price')); ?>'
					}, {
						field: 'hire_date',
